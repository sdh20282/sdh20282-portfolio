...
export function NavbarTitle() {
  return (
    <Link href="/" className='group cursor-pointer text-white' passHref>
      <Magnetic className='p-5 flex'>
        ...
        <div className='relative ms-2 flex overflow-hidden whitespace-nowrap transition-all duration-500 ease-in-out group-hover:pe-8'>
          <p className='transition-transform duration-500 ease-in-out group-hover:-translate-x-full text-white'>
            Code by
          </p>
