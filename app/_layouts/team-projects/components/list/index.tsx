...
const List = ({ props: {
  ...
  return (
    ...
    >
      <Link href="/" className='flex justify-between items-center max-lg:flex-wrap transition-all duration-300 text-[#fff] px-[7vw] py-[4.5vw] group-hover:px-[5vw] group-hover:text-[#777]'>
        <p
          style={{
